        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, axios_1.default.post(this.emailURL, data, {
                    ...
                    case 3:
                        e_1 = _a.sent();
                        logger_1.default.debug("Logging email URL: " + this.emailURL);
                        logger_1.default.error("Something went wrong while sending email. " + JSON.stringify(e_1));
                        return [3 /*break*/, 4];
